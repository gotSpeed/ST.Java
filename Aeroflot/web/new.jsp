    ...
    <div class="body-container">
      ...
      <div class="content-container">
        ...
        <form class="new-flight-form" method="POST" action="/new">
          <label class="register-form-label">Departure date and time
            <input type="text"
          ...
          <label class="register-form-label">Arrival date and time
            <input type="text"
          ...
          <label class="register-form-label">Departure point
          ...
          <label class="register-form-label">Arrival point
          ...
          <label class="register-form-label">Plane
            <select name="plane">
